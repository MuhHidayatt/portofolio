          ...
          {CONTACTS.map(({ icon: Icon, label, value, href, accent }) => {
            ...
            return (
              <motion.a
                ...
                className={`${gridSpan} glass rounded-2xl p-6 border border-[--color-border] flex flex-col items-center gap-4 text-center transition-all duration-300 group ${
                  isCyan
